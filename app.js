...
const DRONE_SAMPLE_SOURCES = {
  harmonium: { url: 'samples/harmonium/C3.mp3', baseMidi: 48, loopStart: 0.8, loopEnd: 11.7, fade: 0.02 },
  organ:     { url: 'samples/organ/C3.mp3',      baseMidi: 48, loopStart: 0.8, loopEnd: 10.0, fade: 0.02 },
};
